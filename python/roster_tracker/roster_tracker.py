...
def get_all_events_from_start_to_end(start_dt, end_dt):
    ...
    for event_start_dt in sorted_start_dts:
        ...
        if (start_dt <= event_start_dt <= end_dt or start_dt <= event_end_dt <= end_dt) and player_count > MINIMUM_ATTENDANCE_NUMBER:
...
def get_attendance_rates_from_event_url(event_url):
    ...
    for player_row in player_rows:
        ...
        attendance = attendance_parts_dict["width"] / (100.0 - attendance_parts_dict["margin-right"] - attendance_parts_dict["margin-left"])
